...
class Level1(tools._State):
    ...
    def set_game_info_values(self):
        ...
        if self.persist[c.LIVES] == 0:
            ...
            self.next = c.LEVEL2  # Vai para a fase 2 após completar a fase 1
            self.game_info[c.CAMERA_START_X] = 0
    ...
    def end_game(self):
        ...
        if self.flag_timer == 0:
            ...
            self.set_game_info_values()
            # Only set GAME_OVER if Mario is dead or out of lives
            # Otherwise, preserve the transition set in set_game_info_values()
            if self.mario.dead or self.persist[c.LIVES] == 0:
                self.next = c.GAME_OVER
